...
public class UIBuilder {
    ...
    private VBox createManualControlPanel() {
        ...
        frame.getChildren().addAll(title, dpad, stepLabel, radioRow);
    ...
    private void updateLastCheckLabel() {
        espLastCheckLabel.setText("Son kontrol: " + LocalTime.now().format(TIME_FORMATTER));
    }
